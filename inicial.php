      ...
      <div class="app-container">
        ...
        <div class="app-body">
          ...
          <div class="container">
            ...
            <!-- Row start pedidos tabs-->
            <?php include "../pedidos/tabs_percent.php"; ?>
            <!-- Row end pedidos tabs -->

            <!-- Row start titulos tabela -->
            <?php include "../pedidos/tabela_titulos.php"; ?>
            <!-- Row end titulos tabelas-->
