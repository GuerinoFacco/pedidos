        ...
        <div class="card-body">
          <div class="d-flex mb-2">
            ...
            <div class="d-flex flex-column">
              ...
              <p class="m-0 opacity-50">Pedidos digitados</p>
            </div>
          </div>
          <div class="m-0">
        ...
        <div class="card-body">
          <div class="d-flex mb-2">
            ...
            <div class="d-flex flex-column">
              ...
              <p class="m-0 opacity-50">Pedidos em aberto</p>
            </div>
          </div>
          <div class="m-0">
            <div class="progress thin mb-2">
        ...
        <div class="card-body">
          <div class="d-flex mb-2">
            ...
            <div class="d-flex flex-column">
              ...
              <p class="m-0 opacity-50">Pedidos cancelados</p>
            </div>
          </div>
          <div class="m-0">
            <div class="progress thin mb-2">
        ...
        <div class="card-body">
          <div class="d-flex mb-2">
            ...
            <div class="d-flex flex-column">
              ...
              <p class="m-0 opacity-50">Pedidos faturados</p>
            </div>
          </div>
          <div class="m-0">
            <div class="progress thin mb-2">
